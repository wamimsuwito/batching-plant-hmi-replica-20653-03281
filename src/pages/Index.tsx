        ...
        <div className="w-full h-[calc(100vh-80px)] border-4 border-hmi-border bg-hmi-panel relative">
          ...
          >
            ...
            <g id="aggregate-section">
              ...
              <line x1="220" y1="252" x2="210" y2="270" className="stroke-hmi-border" strokeWidth="2" />
              <line x1="300" y1="252" x2="210" y2="270" className="stroke-hmi-border" strokeWidth="2" />
              ...
              <ConveyorBelt x={101} y={370} width={215} angle={0} isRunning={componentStates.beltBawah} />
